    ...
    <footer className="grid-container">
      <main className="col-start-2 col-end-3 flex flex-col md:flex-row justify-between border-t-2 pt-10 md:pt-20 pb-8 md:pb-16">
        <div className="max-w-md text-xl mb-4 md:mb-0">
          <h1>
            Build your own future. <br />Download now free and get 100% boost!
          </h1>
        </div>
      ...
      <main className="col-start-2 col-end-3 grid grid-cols-2 md:grid-cols-4 justify-between border-t-2 py-10 text-sm">
        <div className="mb-4">
          {footerLinks1.map((element) => (
            <h1 className="hover:text-darkBlue cursor-pointer" key={element}>{element}</h1>
          ))}
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          <p className="mb-4">231 North Star 34th Street, Suite #100 Cupertino, 98103</p>
          <a href="top">
            <Image src="/images/Logo.png" width={150} height={25} />
          </a>
        </div>
      </main>
